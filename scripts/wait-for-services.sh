...
DEFAULT_SERVICES=(
  ...
  "8086:/api/actuator/health"
  "8087:/api/actuator/health"
  "8088:/api/actuator/health"
  "8089:/api/actuator/health"
  "8090:/api/actuator/health"
  "8091:/api/actuator/health"
  "8093:/api/actuator/health"
  "8094:/api/actuator/health"
  "8095:/api/actuator/health"
  "8096:/api/actuator/health"
  "8097:/api/actuator/health"
  "8098:/api/actuator/health"
  "8099:/api/actuator/health"
)
