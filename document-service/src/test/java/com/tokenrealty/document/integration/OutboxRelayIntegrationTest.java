...
import com.tokenrealty.document.kafka.outbox.OutboxEvent;
import com.tokenrealty.document.kafka.outbox.OutboxEventRepository;
import com.tokenrealty.document.kafka.outbox.OutboxRelayWorker;
...
@DisplayName("Document outbox relay integration test")
class OutboxRelayIntegrationTest {
    ...
    void relayPending_marksPublished() {
        ...
        outboxEventRepository.save(OutboxEvent.builder()
                ...
                .eventType(DocumentKafkaEventTypes.DOCUMENT_UPLOADED)
        ...
        when(kafkaTemplate.send(
                eq(DocumentKafkaEventTypes.DOCUMENT_UPLOADED),
